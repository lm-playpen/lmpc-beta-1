...
| 3 | Llama-3.1-8B-Instruct | 2025-09-15 | Team Postblitz | 32.3 | 55.5 | Supervised playing architecture. The player (Llama-3.1-8B-Instruct) receives advice on how to improve its play from the advisor (Qwen2.5-32B-Instruct) during inference |
| 4 | Llama-3.1-8B-Instruct (base) | 2025-07-03 | OrgTeam | 29.05      | 55.45     | The unmodified base model (*updated 2025-07-16, fixed eval pipeline*) |
...
| 6 | Llama-3.1-8B-It-4bit (base) | 2025-07-03 | Team Potzblitz | 27.35 | 49.16       | The base model, 4bit quantized (*updated 2025-08-22, added statscore*) |
...
| 8 | Llama-3.1-8B-Instruct | 2025-09-15 | Team Postblitz | 16.05 | 46.87 | Reasoning architecture. The player (Llama-3.1-8B-Instruct) generates several answers, which are scored by the PRM (RLHFlow/Llama3.1-8B-PRM-Deepseek-Data); the best answer is then selected using a reasoning strategy (beam search) |
